    ...
    <div class="app-page-title">
        <div class="page-title-wrapper">
            <div class="page-title-heading">
                ...
                <div>@choice('functionalities.plans', 1)
                    <div class="page-title-subheading">¿Sabías que? Las suricatas tienen una manera curiosa de organizarse en comunidades
                    </div>
                </div>
            </div>
            <div class="page-title-actions">
                <a class="btn btn-primary" href="{{ route('plans.create') }}">{{ __('functionalities.create') }} @choice('functionalities.plans', 1)</a>  
            </div>   
        </div>
    </div>
            ...
            @if($plans->isNotEmpty())
                <div class="main-card mb-3 card">
                    ...
                    <div class="card-body">
                        ...
                        {{ $plans->appends(['search' => Request::get('search')])->links() }}
                    </div>  
                </div>
            @else
