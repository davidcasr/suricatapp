    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="mainNav">
            <ul class="navbar-nav ">
                ...
                <li class="nav-item">
                    <a class="nav-link smoth-scroll" href="#service">Características</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link smoth-scroll" href="#pricing">Precios</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link smoth-scroll" href="#blog">Blog</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link smoth-scroll" href="#footer">Contáctenos</a>
                </li>
